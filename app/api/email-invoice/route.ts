...
export async function POST(request: NextRequest) {
  try {
    ...
    const emailLines = [
      ...
      ``,
      `--${boundary}`,
      `Content-Type: application/pdf; name="Invoice_#${inv.invoice_number}_David_Cossey_Piano_Tuner.pdf"`,
      `Content-Disposition: attachment; filename="Invoice_#${inv.invoice_number}_David_Cossey_Piano_Tuner.pdf"`,
